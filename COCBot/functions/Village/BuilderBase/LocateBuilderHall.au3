Func LocateBuilderHall()
	...
	If $g_aiBuilderHallPos[0] > 0 And $g_aiBuilderHallPos[1] > 0 Then
		...
		Local $aResult = BuildingInfo(242, 476 + $g_iBottomOffsetY) ; Get building name and level with OCR
...
Func _LocateDoubleCannon($bCollect = False)
	...
	If $g_aiDoubleCannonPos[0] <> -1 And $g_aiDoubleCannonPos[1] <> -1 Then
		...
		Local $sInfo = BuildingInfo(242, 476 + $g_iBottomOffsetY)
	...
	While 1
		...
		$sInfo = BuildingInfo(242, 476 + $g_iBottomOffsetY); 860x780
		If @error Then SetError(0, 0, 0)
